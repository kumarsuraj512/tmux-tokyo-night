...
function generate_active_window_string() {
  ...
  # echo "${separator_start}#[fg=${PALLETE[black]}]#I:#{window_panes}${separator_internal}#[fg=${PALLETE[black]}] #{?window_zoomed_flag,$zoomed_window_icon,$active_window_icon}${active_window_title}#{?pane_synchronized,$pane_synchronized_icon,}${separator_end}#[none]"
  echo "${separator_start}#[fg=${PALLETE[black]}]#I#{?#{>=:#{window_panes},2},:#{window_panes},}${separator_internal}#[fg=${PALLETE[black]}] #{?window_zoomed_flag,$zoomed_window_icon,$active_window_icon}${active_window_title}#{?pane_synchronized,$pane_synchronized_icon,}${separator_end}#[none]"
}
